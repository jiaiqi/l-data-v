<template>
  <div class="hual">
    ...
    <RequestForm
      ...
      @app-change="getServiceName()"
      @service-change="getColumns()"
      @req-option-change="changeReqOption"
      ref="requestForm"
    />
...
import ColumnsConfig from "@/components/request-builder/ColumnsConfig.vue";
